...
contract SwapContract {
  ...
  function calculateValue(address tokenSendAddress, address tokenRecieveAddress) public view returns (uint256 value) {
    value = (1 ether) * IERC20(tokenSendAddress).balanceOf(address(this)) / ERC20(tokenRecieveAddress).balanceOf(address(this));
  }
